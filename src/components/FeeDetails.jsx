		...
		sch: PropTypes.shape({
			...
			academicYears: PropTypes.arrayOf(
				PropTypes.shape({
					...
					ActualPay: PropTypes.number.isRequired,
					SchReceived: PropTypes.number,
				})
			).isRequired,
			OtherSch: PropTypes.number,
			FeePaidbyTheStudent: PropTypes.number,
			TotalFeePaid: PropTypes.number,
			TotalSch: PropTypes.number,
		}).isRequired,
