...
StudentEdit.propTypes = {
	setMessage: PropTypes.func.isRequired, // Validate that setMessage is a required function
	triggerSnackbar: PropTypes.func.isRequired, // Validate that triggerSnackbar is a required function
}
